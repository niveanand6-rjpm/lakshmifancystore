...
function renderStockModule() {
  ...
  return `
    ...
    <div class="card">
      <div class="flex-between"><h2 style="margin:0;">Stock List (${items.length})</h2><button class="btn btn-outline btn-sm" onclick="LFS.exportModule('lfs_inventory')">Export JSON</button></div>
...
function renderRentalInvModule() {
  ...
  return `
    ...
    <div class="card">
      <div class="flex-between"><h2 style="margin:0;">Rental Master Data (${items.length})</h2><button class="btn btn-outline btn-sm" onclick="LFS.exportModule('lfs_rental_items')">Export JSON</button></div>
      <div class="table-wrap">
        <table>
...
function renderStaffProfiles() {
  ...
  return `
    ...
    <div class="card">
      <div class="flex-between"><h2 style="margin:0;">Employees (${staff.length})</h2><button class="btn btn-outline btn-sm" onclick="LFS.exportModule('lfs_staff')">Export JSON</button></div>
      <div class="table-wrap">
        <table>
...
function renderExpenseLog() {
  ...
  return `
    ...
    <div class="card">
      <div class="flex-between"><h2 style="margin:0;">Expense Log</h2><button class="btn btn-outline btn-sm" onclick="LFS.downloadCSV('expenses.csv', LFS.get('lfs_expenses'))">Export CSV</button></div>
...
function renderUsageModule() {
  ...
  return `
    <div class="card">
      <div class="flex-between"><h2 style="margin:0;">Jewellery Usage &amp; Earnings</h2><button class="btn btn-outline btn-sm" onclick="LFS.downloadCSV('jewellery_usage.csv', LFS.get('lfs_rental_items').map(i=>({item:i.itemName,code:i.itemCode,timesRented:i.timesRented||0,totalEarned:i.totalEarned||0})))">Export CSV</button></div>
...
function renderSalesReportModule() {
  ...
  return `
    ...
    <div class="card">
      <div class="flex-between"><h3 style="margin:0;">Daily Sales</h3><button class="btn btn-outline btn-sm" onclick="LFS.downloadCSV('sales.csv', LFS.get('lfs_sales'))">Export CSV</button></div>
      <div class="table-wrap">
        <table>
    ...
    <div class="card">
      <div class="flex-between"><h3 style="margin:0;">Rentals</h3><button class="btn btn-outline btn-sm" onclick="LFS.downloadCSV('rentals.csv', LFS.get('lfs_rentals'))">Export CSV</button></div>
      <div class="table-wrap">
        <table>
...
function renderCustomersModule() {
  ...
  return `
    ...
    <div class="card">
      <div class="flex-between"><h2 style="margin:0;">Customers (${customers.length})</h2><button class="btn btn-outline btn-sm" onclick="LFS.exportModule('lfs_customers')">Export JSON</button></div>
      <div class="table-wrap">
        <table>
